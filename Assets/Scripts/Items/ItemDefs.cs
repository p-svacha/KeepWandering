...
public static class ItemDefOf
{
    ...
    public static ItemDef NimbleRoot;
    public static ItemDef NutSnack;
    public static ItemDef OilLamp;
    public static ItemDef Postcard;
    public static ItemDef ProteinShake;
    public static ItemDef Shovel;
    public static ItemDef Rope;
    public static ItemDef Screwdriver;
    public static ItemDef SurvivalBook;

...
public static class EncounterDefs
{
    ...
    public static List<EncounterDef> Defs => new List<EncounterDef>()
    {
        ...
        new EncounterDef("Bandits")
        {
            ...
            Rarity = new Dictionary<BiomeDef, Rarity>
            {
                  { BiomeDefOf.City, Rarity.Common },
                  { BiomeDefOf.Outskirts, Rarity.Occasional },
                  { BiomeDefOf.Woods, Rarity.Rare },
            },
            CameraZoomLevel = 7f,
        ...
        new EncounterDef("Crate")
        {
            ...
            {
                  { BiomeDefOf.City, Rarity.Common },
                  { BiomeDefOf.Outskirts, Rarity.Common },
                  { BiomeDefOf.Woods, Rarity.Occasional },
            },
        ...
        new EncounterDef("SupplyStash")
        {
            ...
            Rarity = new Dictionary<BiomeDef, Rarity>
            {
                  { BiomeDefOf.City, Rarity.VeryRare },
                  { BiomeDefOf.Outskirts, Rarity.VeryRare },
                  { BiomeDefOf.Woods, Rarity.VeryRare },
            },
            CameraZoomLevel = EncounterCamera.DEFAULT_CAMERA_SIZE,
        ...
        new EncounterDef("RadioTower")
        {
            ...
            Rarity = new Dictionary<BiomeDef, Rarity>
            {
                  { BiomeDefOf.City, Rarity.Never },
                  { BiomeDefOf.Outskirts, Rarity.Common },
                  { BiomeDefOf.Woods, Rarity.Common },
            },
            CameraZoomLevel = 12f,
            MinOccurences = 2,
            MaxOccurences = 2,

...
public static class StringExtensions
{
    ...
    /// <summary>
    /// Uncapitalizes the first letter of the string, taking into account HTML-like tags at the start.
    /// </summary>
    /// <param name="str">The string whose first character should be uncapitalized.</param>
    /// <returns>
    /// The input string with its first character converted to lower case, or the original
    /// string if it is null, empty, or already lower case.
    /// </returns>
